...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className='duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] relative isolate w-[380px] transition-transform will-change-transform [aspect-ratio:15/21] [contain:layout_style] [perspective:600px]'
      ref={refElement}
      onPointerMove={event => {
