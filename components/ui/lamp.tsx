...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        /*aca hice un target para lg y md */
        'relative z-0 flex w-full flex-col items-center justify-center rounded-md bg-slate-950 md:h-[80vh] lg:h-[60vh]',
        className
      )}
    >
      <div className='relative isolate z-0 mt-60 flex w-full flex-1 scale-y-125 items-center justify-center'>
        <motion.div
        ...
        <div className='scale-x-150translate-y-12 absolute top-1/2 h-48 w-[60%] max-w-[120%] scale-x-150 bg-slate-950 blur-2xl'></div>
