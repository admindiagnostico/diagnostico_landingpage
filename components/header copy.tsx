...
//   return (
//     <header className='bg-blur sticky left-0 top-0 z-40 w-full bg-background'>
...
//               Busqueda
//               <ShortcutHint className='pointer-events-none ml-10 inline-flex h-6 select-none items-center gap-1 rounded bg-muted px-2 font-mono text-[10px] font-medium text-muted-foreground opacity-100'>
//                 ⌘ K
//               </ShortcutHint>
//             </SearchButton>
//           </CommandBar>
